...
export default function Navbar() {
  ...
  const handleLogout = async () => {
    try {
      ...
      // Trigger checkAuth after logout to update user state
      checkAuth();
      navigate('/login');
    } catch (err) {
  ...
  useEffect(() => {
    // Trigger checkAuth when the component mounts or when isAuthtenicted changes
    checkAuth();
  }, [checkAuth, isAuthtenicted]); // Added isAuthtenicted as a dependency to rerun when auth state changes
